...
(function ($, window, document, undefined) {
    ...
    TwbsFlickrCarousel.prototype = {
        ...
        createCarouselInner: function() {
            ...
            if (carouselInner === undefined || carouselInner.length === 0) {
                ...
                var placeHolderUrl = "<img src='http://www.placehold.it/600x400/000000/ffffff/?text= '>";
        ...
        getPhotoInfo: function(photo, addClass) {
            ...
            $.getJSON(this.settings.flickrApiUrl, {
                ...
                if (data.stat !== "ok") {
                    ...
                    if (addClass === 'active') {
                        $("flickr-carousel").removeClass('item active');
        ...
        getPhotos: function(pageNumber) {
            ...
            $.getJSON(this.settings.flickrApiUrl, {
                ...
                api_key: '43b56406a25923178224e49e80990cd4',
                photoset_id: '72157655870113704',
                user_id:'132225990@N06',
                per_page: '15',
                page: '1',
                privacy_filter: '1',
                format: "json",
    ...
    $.fn.twbsFlickrCarousel.defaults = {
        flickrApiKey: '43b56406a25923178224e49e80990cd4',
        flickrApiUrl: 'https://api.flickr.com/services/rest/',
        photosetId: '72157655870113704',
        userId:'132225990@N06',
        perPage: '15',
        page: '1',
        privacyFilter: '1',
        onPageClick: null,
